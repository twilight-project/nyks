...
function createBaseMerkelRool(): MerkelRool {
  return { hash: "" };
}

export const MerkelRool = {
  encode(message: MerkelRool, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hash !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MerkelRool {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMerkelRool();
  ...
  fromPartial<I extends Exact<DeepPartial<MerkelRool>, I>>(object: I): MerkelRool {
    const message = createBaseMerkelRool();
...
export const ConsensusState = {
  ...
  fromJSON(object: any): ConsensusState {
    return {
      ...
      root: isSet(object.root) ? MerkelRool.fromJSON(object.root) : undefined,
    };
  },
  ...
  toJSON(message: ConsensusState): unknown {
    ...
    message.root !== undefined && (obj.root = message.root ? MerkelRool.toJSON(message.root) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ConsensusState>, I>>(object: I): ConsensusState {
    ...
    message.root = (object.root !== undefined && object.root !== null)
      ? MerkelRool.fromPartial(object.root)
      : undefined;
    return message;
  },
};
