...
import TwilightprojectNyksBootstrap from './twilightproject.nyks.bootstrap'
...
import TwilightprojectNyksFragment from './twilightproject.nyks.fragment'
...
export default { 
  TwilightprojectNyksBootstrap: load(TwilightprojectNyksBootstrap, 'twilightproject.nyks.bootstrap'),
  ...
  TwilightprojectNyksFragment: load(TwilightprojectNyksFragment, 'twilightproject.nyks.fragment'),
