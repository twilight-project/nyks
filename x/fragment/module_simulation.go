...
import (
	...
	fragmentsimulation "github.com/twilight-project/nyks/x/fragment/simulation"
...
var (
	_ = sample.AccAddress
	_ = fragmentsimulation.FindAccount
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	fragmentGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&fragmentGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		fragmentsimulation.SimulateMsgSignerApplication(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		fragmentsimulation.SimulateMsgAcceptSigners(am.accountKeeper, am.bankKeeper, am.keeper),
	))
