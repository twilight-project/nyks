...
var (
	...
	ErrSignerApplicationExists            = sdkerrors.Register(ModuleName, 25, "Signer application or given btc pk already exists")
	ErrInsufficientFunds                  = sdkerrors.Register(ModuleName, 26, "Signer address has insufficient funds")
	ErrVoltModuleAccountNotFound          = sdkerrors.Register(ModuleName, 27, "Volt module account not found")
	ErrCouldNotReturnSignerApplicationFee = sdkerrors.Register(ModuleName, 28, "Could not return signer application fee")
)
