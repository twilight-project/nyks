...
func SimulateMsgRegisterReserveAddress(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		// TODO: Handling the RegisterReserveAddress simulation

		return simtypes.NoOpMsg(types.ModuleName, msg.Type(), "RegisterReserveAddress simulation not implemented"), nil, nil
	}
}
