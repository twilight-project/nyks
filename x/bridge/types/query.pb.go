...
type QueryUnsignedTxRefundRequest struct {
	...
	JudgeAddress string `protobuf:"bytes,2,opt,name=judgeAddress,proto3" json:"judgeAddress,omitempty"`
	BtcTxPrefix  string `protobuf:"bytes,3,opt,name=btcTxPrefix,proto3" json:"btcTxPrefix,omitempty"`
}
...
func (m *QueryUnsignedTxRefundRequest) GetBtcTxPrefix() string {
	if m != nil {
		return m.BtcTxPrefix
	}
	return ""
}
...
func (m *QueryProposeSweepAddressRequest) GetJudgeAddress() string {
	if m != nil {
		return m.JudgeAddress
	}
	return ""
...
func (m *QueryProposeSweepAddressRequest) GetBtcAddress() string {
	if m != nil {
		return m.BtcAddress
	}
	return ""
...
var fileDescriptor_8482370855e6a811 = []byte{
	...
	,
}
...
func (m *QueryUnsignedTxRefundRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BtcTxPrefix) > 0 {
		i -= len(m.BtcTxPrefix)
		copy(dAtA[i:], m.BtcTxPrefix)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.BtcTxPrefix)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.JudgeAddress) > 0 {
...
func (m *QueryUnsignedTxRefundRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BtcTxPrefix", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BtcTxPrefix = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
