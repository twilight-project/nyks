...
type MsgMsgConfirmBtcDeposit struct {
	...
	CosmosDepositAddress string `protobuf:"bytes,6,opt,name=cosmosDepositAddress,proto3" json:"cosmosDepositAddress,omitempty"`
...
func (m *MsgMsgConfirmBtcDeposit) GetCosmosDepositAddress() string {
	if m != nil {
		return m.CosmosDepositAddress
	}
	return ""
}
...
type MsgMsgConfirmBtcDepositResponse struct {
	CosmosDepositAddress string `protobuf:"bytes,1,opt,name=cosmosDepositAddress,proto3" json:"cosmosDepositAddress,omitempty"`
}
...
func (m *MsgMsgConfirmBtcDepositResponse) GetCosmosDepositAddress() string {
	if m != nil {
		return m.CosmosDepositAddress
	}
	return ""
...
var fileDescriptor_41dc2e30e6049cae = []byte{
	...
	0x2e, 0xd6, 0x83, 0xa8, 0x52, 0x5a, 0xcd, 0xc4, 0x25, 0xee, 0x5b, 0x9c, 0xee, 0x5b, 0x9c, 0xee,
	...
	,
}
...
func (m *MsgMsgConfirmBtcDeposit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CosmosDepositAddress) > 0 {
		i -= len(m.CosmosDepositAddress)
		copy(dAtA[i:], m.CosmosDepositAddress)
		i = encodeVarintTx(dAtA, i, uint64(len(m.CosmosDepositAddress)))
		i--
		dAtA[i] = 0x32
	}
...
func (m *MsgMsgConfirmBtcDeposit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CosmosDepositAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CosmosDepositAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
