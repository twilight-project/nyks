...
type VoltKeeper interface {
	...
	RegisterNewFragment(ctx sdk.Context, judgeAddress sdk.AccAddress, reserveAddress string, threshold uint64, applicationFee uint64, numOfSigners uint64, fragmentFeeBips uint64, arbitraryData string) (uint64, uint64, error)
