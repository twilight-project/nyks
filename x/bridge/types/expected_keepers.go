...
type VoltKeeper interface {
	...
	RegisterNewFragment(ctx sdk.Context, judgeAddress sdk.AccAddress, reserveAddress string, threshold uint32, applicationFee uint64, numOfSigners uint32, fragmentFeeBips uint32, arbitraryData string) (uint64, uint64, error)
